      ...
      <div className="container mx-auto max-w-5xl">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          <div>
            ...
            <h2 className="text-5xl font-bold text-ebony serif tracking-tighter italic">Salutations, {user.name.split(' ')[0]}</h2>
          </div>
          <button 
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="bg-white p-10 rounded-[3.5rem] border border-gold-100 shadow-sm">
            ...
            <Link to="/track" className="block bg-ebony p-8 rounded-[2.5rem] text-gold-400 hover:scale-[1.02] transition-transform shadow-xl shadow-ebony/20 group">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {userOrders.length === 0 ? (
              <div className="bg-white p-20 rounded-[4rem] border border-gold-100 text-center opacity-40">
              ...
              <div className="space-y-6">
                {userOrders.map((order) => (
                  <div key={order.id} className="bg-white p-8 rounded-[3rem] border border-gold-100 hover:border-gold-400 transition-all group">
